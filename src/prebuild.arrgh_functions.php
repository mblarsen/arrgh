...
function arrgh_contains()
{
    return Arrgh::contains(...func_get_args());
}
function arrgh_except()
{
...
function arrgh_fill_keys()
{
    return Arrgh::fill_keys(...func_get_args());
}
function arrgh_filter()
{
...
function arrgh_merge()
{
    return Arrgh::merge(...func_get_args());
}
function arrgh_merge_recursive()
{
...
function arrgh_splice()
{
    return Arrgh::splice(...func_get_args());
}
function arrgh_unshift()
{
